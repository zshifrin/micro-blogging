...
<div class="container">
	<div class="row">
		<div class="col-md-4">
			...
			<h2>Username</h2>
			<button type="button" id="follow-btn" class="btn btn-sm btn-default">Follow</button>
			...
			<button type="button" id="edit-profile-btn" class="btn btn-sm btn-info">Edit Profile</button>
		</div>
